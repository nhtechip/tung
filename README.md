...
This repository contains the source code for the [MyApp](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.nhtechip.andriod.myapp).

Please see the [issues](https://github.com.nhtechip.andriod.myapp/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about MyApp? Ask away on the [com-nhtechip-andriod-myapp discussion forum](https://groups.google.com/forum/#!forum/com-nhtechip-andriod-myapp). 

<a href="https://play.google.com/store/apps/details?id=com.nhtechip.andriod.myapp" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.nhtechip.andriod.myapp__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.nhtechip.andriod.myapp__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.nhtechip.andriod.myapp.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall MyApp from your device and
...
You can then import the MyApp project by doing File/Import/Gradle/Gradle Project
and the clicking the Browse button to point to the MyApp directory.  Click
...
MyApp is a result of a template project I've developed over the years as well as
...
MyApp is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.nhtechip.andriod.myapp/contributors) on this project. Your help is much appreciated.


## Contributing

Please fork this repository and contribute back using
[pull requests](https://github.com.nhtechip.andriod.myapp/pulls).
